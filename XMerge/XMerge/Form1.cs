...
namespace XMerge
{
    public partial class Form1 : Form
    {
        ...
        HashSet<string> ComparisonNames = new HashSet<string>();
        ...
        public Form1()
        {
            ...
            lstFilters = new List<CheckBox> { chkHTML, chkXML, chkSQL, chkBPMN, chkNS};
        ...
        private void btnCompare_Click(object sender, EventArgs e)
        {
           ...
           if(!IsFilterSelected)
            {
                MessageBox.Show("Please check the Filters before comparing.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return; 
            }
                
            

            if (txtComparisonName.Text.Length == 0)
            {
                ComparisonName = $"Comparison {ComparisonIndex}";
            }
            else
            {
                ComparisonName = txtComparisonName.Text;
            }
