...
namespace XMerge
{
    public class CompareFolders
    {
        ...
        public Collection<FileDetails>? clnFileDetails;
        ...
        private void ComparingCheckedFolders(string CommonFolderPath)
        {
            ...
            //ComparingFolderFiles(appBaseFolder!, appFolder!, "");
        }
        ...
        {
            foreach (FileDetails FileDetail in clnFileDetails!.Where(f => f.IsAppBase == false && f.IsMatchingFilePresent == true && f.IsIdentical == false))
            {
                LineDifferences_ExportToTextFile(FileDetail.FileRelativePath);
            }
        ...
        public void LineDifferences_ExportToTextFile(string RelativePath)
        {
